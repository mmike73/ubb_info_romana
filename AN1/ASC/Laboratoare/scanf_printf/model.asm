...
segment data use32 class=data
	n dd  0   
    m dd 0; in aceasta variabila se va stoca valoarea citita de la tastatura
    ; sirurile de caractere sunt de tip byte
	message  db "Introdu doua numere:", 0  ; sirurile de caractere pentru functiile C trebuie sa se termine cu valoarea 0 (nu caracterul)
...
segment code use32 class=code
    start:
        ...
        add esp, 4 * 2
        mov edx, [m]; eliberam parametrii de pe stiva
        mov eax, [n] ; 4 = dimensiuneadword; 2 = nr de parametri
